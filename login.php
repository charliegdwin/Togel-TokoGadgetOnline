...
if (isset($_POST['submit'])) {
    ...
    $validasi = mysqli_query($koneksi, $sql);
...
<body>
    ...
    <div class="container">
        <form action="" method="POST" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">Login Togel</p>
            ...
            <p class="login-register-text">Anda belum punya akun? <a href="form.php">Register</a></p>
        </form>
    </div>
</body>
</html>
