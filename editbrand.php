...
//agar jika admin langsung membuka link web dashboard, maka akan diarahkan ke halaman login dulu
  ...
  $kategori = mysqli_query($koneksi, "SELECT * FROM brand WHERE id = '".$_GET['id']."'");
    ...
    <div class="sales-boxes">
       <div class="top-sales box">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
          <input type="text" name="nama" placeholder="Nama Kategori" class="inputprofil" value="<?php echo $k-> namabrand ?>"required>
          <img src="brand/<?php echo $k->gambarbrand ?>" width="200px">
          <input type="hidden" name="foto" value="<?php echo $k->gambarbrand ?>">
